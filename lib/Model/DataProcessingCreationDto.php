...
/**
 * DataProcessingCreationDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DataProcessingCreationDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataProcessingCreationDto';
    ...
    public function setLabel($label)
    {
        if ((mb_strlen($label) > 80)) {
            throw new \InvalidArgumentException('invalid length for $label when calling DataProcessingCreationDto., must be smaller than or equal to 80.');
        }
