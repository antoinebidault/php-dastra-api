...
/**
 * AreaDataProcessingTreeItemDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AreaDataProcessingTreeItemDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AreaDataProcessingTreeItemDto';
    ...
    protected static $openAPITypes = [
        ...
        'folders' => '\OpenAPI\Client\Model\AreaDataProcessingTreeItemDto[]',
     ...
     * Gets folders
     *
     * @return \OpenAPI\Client\Model\AreaDataProcessingTreeItemDto[]|null
     */
     ...
     * Sets folders
     *
     * @param \OpenAPI\Client\Model\AreaDataProcessingTreeItemDto[]|null $folders folders
     *
     * @return self
     */
    ...
    public function setAddress($address)
    {
        if (!is_null($address) && (mb_strlen($address) > 500)) {
            throw new \InvalidArgumentException('invalid length for $address when calling AreaDataProcessingTreeItemDto., must be smaller than or equal to 500.');
        }
    ...
    public function setZipCode($zip_code)
    {
        if (!is_null($zip_code) && (mb_strlen($zip_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling AreaDataProcessingTreeItemDto., must be smaller than or equal to 10.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 300)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AreaDataProcessingTreeItemDto., must be smaller than or equal to 300.');
        }
    ...
    public function setCountryCode($country_code)
    {
        if (!is_null($country_code) && (mb_strlen($country_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country_code when calling AreaDataProcessingTreeItemDto., must be smaller than or equal to 3.');
        }
    ...
    public function setImmatriculationNumber($immatriculation_number)
    {
        if (!is_null($immatriculation_number) && (mb_strlen($immatriculation_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $immatriculation_number when calling AreaDataProcessingTreeItemDto., must be smaller than or equal to 20.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 14)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling AreaDataProcessingTreeItemDto., must be smaller than or equal to 14.');
        }
    ...
    public function setMailAddress($mail_address)
    {
        if (!is_null($mail_address) && (mb_strlen($mail_address) > 255)) {
            throw new \InvalidArgumentException('invalid length for $mail_address when calling AreaDataProcessingTreeItemDto., must be smaller than or equal to 255.');
        }
