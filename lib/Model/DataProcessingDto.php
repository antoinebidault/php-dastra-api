...
/**
 * DataProcessingDto Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DataProcessingDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataProcessingDto';
    ...
    public function setLabel($label)
    {
        if ((mb_strlen($label) > 120)) {
            throw new \InvalidArgumentException('invalid length for $label when calling DataProcessingDto., must be smaller than or equal to 120.');
        }
        if ((mb_strlen($label) < 1)) {
            throw new \InvalidArgumentException('invalid length for $label when calling DataProcessingDto., must be bigger than or equal to 1.');
        }
    ...
    public function setVersionDescription($version_description)
    {
        if (!is_null($version_description) && (mb_strlen($version_description) > 800)) {
            throw new \InvalidArgumentException('invalid length for $version_description when calling DataProcessingDto., must be smaller than or equal to 800.');
        }
    ...
    public function setRef($ref)
    {
        if (!is_null($ref) && (mb_strlen($ref) > 50)) {
            throw new \InvalidArgumentException('invalid length for $ref when calling DataProcessingDto., must be smaller than or equal to 50.');
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 3000)) {
            throw new \InvalidArgumentException('invalid length for $description when calling DataProcessingDto., must be smaller than or equal to 3000.');
        }
